class AppUrls {
  ...
  static const String createDistributor = "$baseUrl/distribution/create_distributor";
  static const String getDistributors = "$baseUrl/distribution/get_distributors";
